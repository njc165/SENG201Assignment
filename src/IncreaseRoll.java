public class IncreaseRoll extends PowerUp {
	 ...
	 */
	private final static String DESCRIPTION = "When playing Dice Rolls, each Increase Roll power up applied to a hero will increase their roll by one. All Increase Roll power ups applied to the hero will be consumed at the end of a game of Dice Rolls.";
